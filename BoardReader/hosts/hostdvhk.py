...
###################################################
config.plugins.iptvplayer.dvhk_login = ConfigText(default = "", fixed_size = False)
config.plugins.iptvplayer.dvhk_password = ConfigText(default = "", fixed_size = False)
config.plugins.iptvplayer.dvhk_BlockedIDs = ConfigText(default = "7,8,98,31,19,17,103", fixed_size = False)
...
def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry("Login do DVHK:", config.plugins.iptvplayer.dvhk_login))
    optionList.append(getConfigListEntry("Hasło do DVHK:", config.plugins.iptvplayer.dvhk_password))
    optionList.append(getConfigListEntry("Zablokowane podfora (ID):", config.plugins.iptvplayer.dvhk_BlockedIDs))
    return optionList
