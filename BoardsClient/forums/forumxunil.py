...
class MyHost(IHost):
    PATH_TO_LOGO = resolveFilename(SCOPE_PLUGINS, 'Extensions/BoardsClient/icons/xunillogo.png')
    ...
    def __init__(self):
        # urls
        self.DBG = True
        COOKIEFILE = resolveFilename(SCOPE_PLUGINS, 'Extensions/BoardsClient/cache/') + 'xunil.cookie'
