...
from libs.tools import removeAllIconsFromPath, printDBG, IsHostEnabled
...
class ConfigHostMenu(Screen, ConfigListScreen):
    ...
    def __init__(self, session, hostName):
        ...
        self.setup_title = "Konfiguracja ustawień dla playera " + self.hostName
    ...
    def layoutFinished(self):
        self.setTitle("IPTV Player " + self.hostName + " - ustawienia")
